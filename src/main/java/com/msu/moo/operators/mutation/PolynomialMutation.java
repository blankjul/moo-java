...
public class PolynomialMutation implements IMutation<DoubleListVariable> {
	...
	public PolynomialMutation(Range<Double> range) {
		super();
		this.range = range;
	}
	

	public PolynomialMutation(Range<Double> range, double eta_m, double mProbability) {
		super();
		this.range = range;
		this.eta_m = eta_m;
